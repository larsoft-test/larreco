...
#include <cstdlib>
#include <vector>
#include "TrackFinder/test/PropTest.h"
...
namespace trkf {
  ...
  void PropTest::beginJob()
  {
    ...
    const trkf::TrackVector vec1 = tre1.getVector();
    const trkf::TrackError err1 = tre1.getError();
    const trkf::TrackVector vec2 = tre2.getVector();
    const trkf::TrackError err2 = tre2.getError();
    for(unsigned int i=0; i<vec1.size(); ++i) {
