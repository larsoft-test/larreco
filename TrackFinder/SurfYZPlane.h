...
///
/// This surface is defined by three parameters, which are,
/// (y0, z0) - Local origin in yz-plane.
...
namespace trkf {
  ...
  class SurfYZPlane : public Surface
  {
  public:
    ...
    SurfYZPlane(double y0, double z0, double phi);
