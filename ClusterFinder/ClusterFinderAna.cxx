...
//-------------------------------------------------
cluster::ClusterFinderAna::ClusterFinderAna(edm::ParameterSet const& pset) : 
...
//-------------------------------------------------
cluster::ClusterFinderAna::~ClusterFinderAna()
{
...
void cluster::ClusterFinderAna::analyze(const edm::Event& evt,  edm::EventSetup const&)
{
