...
// 
////////////////////////////////////////////////////////////////////////
#ifndef DBSCANFINDERANA_H
#define DBSCANFINDERANA_H
...
namespace cluster {
  ...
  class DBSCANfinderAna : public edm::EDAnalyzer {

  public:
          
    explicit DBSCANfinderAna(edm::ParameterSet const& pset); 
    virtual ~DBSCANfinderAna();
