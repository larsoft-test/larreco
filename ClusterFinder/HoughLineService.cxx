...
cluster::HoughLineService::HoughTransform::HoughTransform()
{  
}
...
bool cluster::HoughLineService::HoughTransform::AddPoint(int x, int y)
{
...
int cluster::HoughLineService::HoughTransform::GetMax(int &xmax, int &ymax)
{
