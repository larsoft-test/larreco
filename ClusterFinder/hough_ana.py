...
process = clusterfinder.Process("ClusterFinderAna")
...
process.houghana = clusterfinder.EDAnalyzer(
    "HoughLineFinderAna",    
     DigitModuleLabel =clusterfinder.string("wiresim"),
     HitsModuleLabel=clusterfinder.string("ffthit"),
...
process.doit = clusterfinder.EndPath(process.caldataCal*process.ffthit*process.dbscan*process.hough*process.houghana*process.output )
